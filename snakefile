...
rule FromRawToCis: 
    ...
    output:
        "/storage/mathelierarea/processed/petear/analysis/{project}/{project}_{tfactor}.csv",
...
rule CSVtoXZ:
    input:
        CSV = "/storage/mathelierarea/processed/petear/analysis/{project}/{project}_{tfactor}.csv"
    output:
        XZ = "/storage/mathelierarea/processed/petear/analysis/{project}/{project}_{tfactor}.csv.xz"
    shell:
